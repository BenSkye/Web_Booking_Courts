...
tournamenRoute
  .route('/cancel-tournament/:tournamentId')
  .put(authController.protect, authController.restricTO('customer'), tournamentController.cancelTournament)
tournamenRoute
...
tournamenRoute
  .route('/confirm-tournament/:tournamentId')
  .put(authController.protect, authController.restricTO('customer'), tournamentController.confirmTournament)
tournamenRoute.route('/callback-confirm-tournament').post(tournamentController.callbackConfirmTournament)
tournamenRoute.route('/tournament-by-invoice/:invoiceId').get(tournamentController.getTournamentByInvoiceId)

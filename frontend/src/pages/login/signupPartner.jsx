...
import RegisterPartner from "../../services/authAPI/RegisterPartnerAPI"; // Import the Register function from the RegisterApi file
const { Text } = Typography;
...
export default function SignUp() {
  ...
  const onFinish = async (values) => {
    ...
    const response = await RegisterPartner(newUser);

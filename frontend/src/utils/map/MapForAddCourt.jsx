...
const MyLocationMap2 = ({ address }) => {
  const [viewport, setViewport] = useState({
    latitude: 10.7769, // Default latitude of Ho Chi Minh City
    longitude: 106.7009, // Default longitude of Ho Chi Minh City
    zoom: 8,
  });
  ...
  useEffect(() => {
    if (address) {
      const mapboxClient = new MapboxClient({ accessToken: mapboxAccessToken });
